...
export type VideoStatus = 'uploading' | 'queued' | 'validating' | 'transcoding' | 'detecting' | 'extracting' | 'ready' | 'analyzing' | 'summarizing' | 'partial' | 'done' | 'failed' | 'cancelled' | 'paused_config';
