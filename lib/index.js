...
var ModelImageBridge = class {
	...
	cachedDescription(attachmentId, sessionId) {
	...
	cacheKey(attachmentId, sessionId) {
...
function apply(ctx) {
	...
	ctx.tools.register(defineTool({
		...
		async execute(args, exec) {
			...
			const cached = modelImages.cachedDescription(attachmentId, exec.agent === void 0 ? void 0 : String(exec.agent.session.id));
