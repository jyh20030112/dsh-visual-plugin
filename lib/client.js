window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		//#region \0dsh-css:/home/arch/Desktop/Dev/deepseek_workspace/dsh-visual-plugin/src/client/DescriptionCopyButton.module.css.mjs
		const css$4 = ".s92QpG_copy{min-height:28px;color:var(--dsw-alias-label-tertiary,#777);cursor:pointer;font:inherit;background:0 0;border:0;border-radius:7px;align-items:center;gap:5px;padding:4px 8px;font-size:11px;transition:background-color .12s,color .12s;display:inline-flex}.s92QpG_copy:hover{background:var(--dsw-alias-interactive-bg-hover,#7f7f7f1a);color:var(--dsw-alias-label-primary,currentColor)}.s92QpG_copy:focus-visible{outline:2px solid var(--dsw-alias-state-business-primary,#4176e6);outline-offset:2px}.s92QpG_copy svg{fill:none;stroke:currentColor;stroke-linecap:round;stroke-linejoin:round;stroke-width:1.5px;width:14px;height:14px}";
		...
		var DescriptionCopyButton_module_css_default = { "copy": "s92QpG_copy" };
		//#endregion
		...
		const css$3 = "._5cyU7a_panel{z-index:1000;width:var(--vision-bridge-panel-width,min(440px, 94vw));box-sizing:border-box;border-left:1px solid var(--dsw-alias-border-l2,#0000001f);background:var(--dsw-alias-bg-base,#fff);color:var(--dsw-alias-label-primary,#0f1115);flex-direction:column;font-size:13px;display:flex;position:fixed;inset:0 0 0 auto;overflow:hidden;box-shadow:-12px 0 36px #00000024}@media (width>=760px){#root:has(._5cyU7a_panel){--vision-bridge-panel-width:clamp(360px, 32vw, 440px);width:calc(100% - var(--vision-bridge-panel-width));transition:width var(--ds-transition-duration-slow,.3s) var(--ds-ease-in-out,ease)}}._5cyU7a_header{justify-content:space-between;align-items:flex-start;gap:20px;padding:22px 22px 16px;display:flex}._5cyU7a_title{letter-spacing:-.01em;font-size:18px;font-weight:650;display:block}._5cyU7a_headerHint{color:var(--dsw-alias-label-tertiary,#62666b);margin:5px 0 0;font-size:12px;line-height:1.45}._5cyU7a_close{width:32px;height:32px;color:var(--dsw-alias-label-secondary,#43454a);cursor:pointer;background:0 0;border:0;border-radius:9px;flex:none;place-items:center;padding:0;display:grid}._5cyU7a_close:hover{background:var(--dsw-alias-interactive-bg-hover,#0000000f);color:var(--dsw-alias-label-primary,#0f1115)}._5cyU7a_close:focus-visible,._5cyU7a_tab:focus-visible,._5cyU7a_tabActive:focus-visible,._5cyU7a_actions button:focus-visible,._5cyU7a_textAction:focus-visible,._5cyU7a_previewPlaceholder:focus-visible,._5cyU7a_historyToggle:focus-visible,._5cyU7a_historyToggleExpanded:focus-visible{outline:2px solid var(--dsw-alias-state-business-primary,#4176e6);outline-offset:2px}._5cyU7a_close svg{fill:none;stroke:currentColor;stroke-linecap:round;stroke-width:1.7px;width:18px;height:18px}._5cyU7a_tabs{background:var(--dsw-specific-selector,#f5f6f7);border-radius:11px;grid-template-columns:1fr 1fr;gap:4px;margin:0 22px;padding:4px;display:grid}._5cyU7a_tab,._5cyU7a_tabActive{min-height:36px;color:var(--dsw-alias-label-tertiary,#62666b);cursor:pointer;font:inherit;background:0 0;border:0;border-radius:8px;padding:7px 14px;font-weight:550;transition:background-color .12s,box-shadow .12s,color .12s;position:relative}._5cyU7a_tab:hover{color:var(--dsw-alias-label-primary,#0f1115)}._5cyU7a_tabActive{background:var(--dsw-alias-bg-layer-1,#fff);color:var(--dsw-alias-label-primary,#0f1115);box-shadow:0 1px 4px #00000014}._5cyU7a_tabDot{background:var(--dsw-alias-state-business-primary,#4176e6);border-radius:50%;width:5px;height:5px;margin-left:5px;position:absolute;top:9px}._5cyU7a_content{overscroll-behavior:contain;scrollbar-gutter:stable;flex:1;min-height:0;padding:20px 22px 28px;overflow-y:auto}._5cyU7a_recentList{flex-direction:column;gap:18px;display:flex}._5cyU7a_view{flex-direction:column;gap:16px;display:flex}._5cyU7a_intro{flex-direction:column;align-items:flex-start;gap:9px;display:flex}._5cyU7a_hint{color:var(--dsw-alias-label-secondary,#4f5359);margin:0;line-height:1.6}._5cyU7a_statusReady,._5cyU7a_statusPending,._5cyU7a_latestBadge{border-radius:999px;align-items:center;min-height:22px;padding:2px 8px;font-size:11px;font-weight:600;display:inline-flex}._5cyU7a_statusReady{background:var(--dsw-alias-state-success-tertiary,#e6faed);color:var(--dsw-alias-state-success-primary,#22a955)}._5cyU7a_statusPending{background:var(--dsw-alias-state-warn-tertiary,#fef5e7);color:var(--dsw-alias-state-warn-label,#b26720)}._5cyU7a_card{border:1px solid var(--dsw-alias-border-l2,#0000001a);background:var(--dsw-alias-bg-layer-2,#fff);border-radius:14px;flex-direction:column;gap:13px;padding:16px;display:flex}._5cyU7a_sectionHeading,._5cyU7a_recentHeading,._5cyU7a_entryTopline,._5cyU7a_entryFooter{justify-content:space-between;align-items:center;gap:12px;display:flex}._5cyU7a_historyToggle,._5cyU7a_historyToggleExpanded{box-sizing:border-box;border:1px solid var(--dsw-alias-border-l2,#0000001a);background:var(--dsw-alias-bg-module-platform,#f5f6f7);width:100%;min-height:36px;color:var(--dsw-alias-label-secondary,#4f5359);cursor:pointer;font:inherit;border-radius:9px;justify-content:space-between;align-items:center;padding:7px 10px;font-size:12px;font-weight:550;display:flex}._5cyU7a_historyToggle:hover,._5cyU7a_historyToggleExpanded{background:var(--dsw-alias-interactive-bg-hover,#7f7f7f1a);color:var(--dsw-alias-label-primary,#0f1115)}._5cyU7a_historyToggle svg,._5cyU7a_historyToggleExpanded svg{fill:none;stroke:currentColor;stroke-linecap:round;stroke-linejoin:round;stroke-width:1.5px;width:15px;height:15px;transition:transform .12s}._5cyU7a_historyToggleExpanded svg{transform:rotate(180deg)}._5cyU7a_historyList{flex-direction:column;gap:10px;padding-top:2px;display:flex}._5cyU7a_historyItem{border-left:2px solid var(--dsw-alias-border-l3,#00000029);background:var(--dsw-alias-bg-module-platform,#f5f6f7);border-radius:0 8px 8px 0;padding:11px 12px}._5cyU7a_historyItemHeader{justify-content:space-between;align-items:center;gap:10px;margin-bottom:6px;display:flex}._5cyU7a_historyItemHeader time{color:var(--dsw-alias-label-caption,#969ba1);font-size:10px}._5cyU7a_historyItem>p,._5cyU7a_historyEmpty{color:var(--dsw-alias-label-secondary,#4f5359);overflow-wrap:anywhere;white-space:pre-wrap;margin:0;font-size:12px;line-height:1.6}._5cyU7a_historyEmpty{color:var(--dsw-alias-label-tertiary,#70747a);padding:10px 2px 2px}._5cyU7a_sectionHeading>span,._5cyU7a_recentHeading p,._5cyU7a_entryTopline time{color:var(--dsw-alias-label-tertiary,#777b81);font-size:11px}._5cyU7a_recentHeading{align-items:flex-start}._5cyU7a_recentHeading p{margin:5px 0 0;line-height:1.45}._5cyU7a_subtitle{margin:0;font-size:14px;font-weight:650}._5cyU7a_field{color:var(--dsw-alias-label-secondary,#4f5359);flex-direction:column;gap:7px;font-size:12px;font-weight:550;display:flex}._5cyU7a_field input{box-sizing:border-box;border:1px solid var(--dsw-alias-border-l3,#00000029);background:var(--dsw-specific-input-major,#fff);width:100%;min-height:40px;color:var(--dsw-alias-label-primary,#0f1115);font:inherit;border-radius:9px;outline:none;padding:9px 11px;transition:border-color .12s,box-shadow .12s}._5cyU7a_field input::placeholder{color:var(--dsw-alias-label-caption,#9aa0a6)}._5cyU7a_field input:focus{border-color:var(--dsw-alias-state-business-primary,#4176e6);box-shadow:0 0 0 3px color-mix(in srgb, var(--dsw-alias-state-business-primary,#4176e6) 16%, transparent)}._5cyU7a_actions{gap:8px;padding-top:2px;display:flex}._5cyU7a_actions button{cursor:pointer;min-height:38px;font:inherit;border-radius:9px;flex:1;padding:8px 12px;font-weight:600}._5cyU7a_primaryAction{border:1px solid var(--dsw-alias-button-info-fill,#4176e6);background:var(--dsw-alias-button-info-fill,#4176e6);color:var(--dsw-static-neutral-00,#fff)}._5cyU7a_primaryAction:hover{border-color:var(--dsw-alias-button-info-hover,#5686fe);background:var(--dsw-alias-button-info-hover,#5686fe)}._5cyU7a_secondaryAction{border:1px solid var(--dsw-alias-border-l3,#00000029);background:var(--dsw-alias-bg-layer-3,#fff);color:var(--dsw-alias-label-primary,#0f1115)}._5cyU7a_secondaryAction:hover{background:var(--dsw-alias-interactive-bg-hover-solid,#f1f3f5)}._5cyU7a_actions button:disabled{cursor:not-allowed;opacity:.45}._5cyU7a_textAction{color:var(--dsw-alias-label-secondary,#4f5359);cursor:pointer;font:inherit;background:0 0;border:0;border-radius:7px;flex:none;padding:5px 7px;font-size:12px}._5cyU7a_textAction:hover{background:var(--dsw-alias-interactive-bg-hover,#0000000f);color:var(--dsw-alias-label-primary,#0f1115)}._5cyU7a_note,._5cyU7a_ok,._5cyU7a_error,._5cyU7a_balanceLine{margin:0;font-size:12px;line-height:1.5}._5cyU7a_note{color:var(--dsw-alias-label-tertiary,#70747a)}._5cyU7a_ok{color:var(--dsw-alias-state-success-primary,#22a955)}._5cyU7a_error{color:var(--dsw-alias-state-error-primary,#ec1313)}._5cyU7a_balanceLine{color:var(--dsw-alias-label-secondary,#4f5359)}._5cyU7a_empty{box-sizing:border-box;border:1px dashed var(--dsw-alias-border-l3,#00000029);background:var(--dsw-alias-bg-module-platform,#f7f8f9);text-align:center;border-radius:16px;flex-direction:column;justify-content:center;align-items:center;min-height:300px;padding:44px 32px;display:flex}._5cyU7a_emptyIcon{background:var(--dsw-alias-state-business-tertiary,#e4edfd);width:52px;height:52px;color:var(--dsw-alias-state-business-primary,#4176e6);border-radius:15px;place-items:center;margin-bottom:17px;display:grid}._5cyU7a_emptyIcon svg{fill:none;stroke:currentColor;stroke-linecap:round;stroke-linejoin:round;stroke-width:1.5px;width:27px;height:27px}._5cyU7a_empty h3{margin:0 0 8px;font-size:14px}._5cyU7a_empty p{max-width:280px;color:var(--dsw-alias-label-tertiary,#70747a);margin:0;font-size:12px;line-height:1.65}._5cyU7a_entry{border:1px solid var(--dsw-alias-border-l2,#0000001a);background:var(--dsw-alias-bg-layer-2,#fff);border-radius:16px;overflow:hidden}._5cyU7a_preview{background:var(--dsw-alias-bg-module-platform,#f5f6f7);place-items:center;min-height:210px;max-height:280px;display:grid;overflow:hidden}._5cyU7a_thumb{object-fit:contain;width:100%;height:240px;display:block}._5cyU7a_previewPlaceholder{width:100%;min-height:210px;color:var(--dsw-alias-label-tertiary,#70747a);cursor:pointer;font:inherit;background:0 0;border:0;font-size:12px}._5cyU7a_entryBody{border-top:1px solid var(--dsw-alias-border-l1,#0000000f);flex-direction:column;gap:12px;padding:16px;display:flex}._5cyU7a_latestBadge{background:var(--dsw-alias-state-business-tertiary,#e4edfd);color:var(--dsw-alias-state-business-primary,#4176e6)}._5cyU7a_description{color:var(--dsw-alias-label-primary,#0f1115);overflow-wrap:anywhere;white-space:pre-wrap;margin:0;font-size:13px;line-height:1.7}._5cyU7a_entryFooter{min-width:0;padding-top:2px}._5cyU7a_meta{min-width:0;color:var(--dsw-alias-label-caption,#969ba1);font-family:var(--ds-font-family-code,monospace);text-overflow:ellipsis;white-space:nowrap;margin:0;font-size:10px;overflow:hidden}@media (width<=520px){._5cyU7a_header{padding:18px 16px 14px}._5cyU7a_tabs{margin:0 16px}._5cyU7a_content{padding:16px}}@media (prefers-reduced-motion:reduce){._5cyU7a_tab,._5cyU7a_tabActive,._5cyU7a_field input{transition:none}}";
		...
		var VisionBridgePanel_module_css_default = {
			"emptyIcon": "_5cyU7a_emptyIcon",
			"historyItem": "_5cyU7a_historyItem",
			"entry": "_5cyU7a_entry",
			"tabs": "_5cyU7a_tabs",
			"sectionHeading": "_5cyU7a_sectionHeading",
			"tab": "_5cyU7a_tab",
			"recentHeading": "_5cyU7a_recentHeading",
			"headerHint": "_5cyU7a_headerHint",
			"historyList": "_5cyU7a_historyList",
			"tabActive": "_5cyU7a_tabActive",
			"textAction": "_5cyU7a_textAction",
			"historyToggleExpanded": "_5cyU7a_historyToggleExpanded",
			"historyItemHeader": "_5cyU7a_historyItemHeader",
			"field": "_5cyU7a_field",
			"card": "_5cyU7a_card",
			"preview": "_5cyU7a_preview",
			"tabDot": "_5cyU7a_tabDot",
			"statusReady": "_5cyU7a_statusReady",
			"view": "_5cyU7a_view",
			"empty": "_5cyU7a_empty",
			"latestBadge": "_5cyU7a_latestBadge",
			"title": "_5cyU7a_title",
			"note": "_5cyU7a_note",
			"ok": "_5cyU7a_ok",
			"secondaryAction": "_5cyU7a_secondaryAction",
			"close": "_5cyU7a_close",
			"meta": "_5cyU7a_meta",
			"subtitle": "_5cyU7a_subtitle",
			"description": "_5cyU7a_description",
			"recentList": "_5cyU7a_recentList",
			"historyToggle": "_5cyU7a_historyToggle",
			"hint": "_5cyU7a_hint",
			"thumb": "_5cyU7a_thumb",
			"entryFooter": "_5cyU7a_entryFooter",
			"header": "_5cyU7a_header",
			"primaryAction": "_5cyU7a_primaryAction",
			"entryBody": "_5cyU7a_entryBody",
			"panel": "_5cyU7a_panel",
			"previewPlaceholder": "_5cyU7a_previewPlaceholder",
			"content": "_5cyU7a_content",
			"statusPending": "_5cyU7a_statusPending",
			"balanceLine": "_5cyU7a_balanceLine",
			"historyEmpty": "_5cyU7a_historyEmpty",
			"error": "_5cyU7a_error",
			"entryTopline": "_5cyU7a_entryTopline",
			"intro": "_5cyU7a_intro",
		...
		*/
		...
		const css$2 = ".rNwIGq_toggle{color:var(--dsw-alias-label-secondary,inherit);cursor:pointer;background:0 0;border:none;border-radius:6px;align-items:center;gap:6px;padding:6px 10px;font-size:13px;display:inline-flex}.rNwIGq_toggle:hover,.rNwIGq_toggle[aria-pressed=true]{background:var(--dsw-alias-interactive-bg-hover,#7f7f7f1a);color:var(--dsw-alias-label-primary,inherit)}.rNwIGq_toggle:focus-visible{outline:2px solid var(--dsw-alias-state-business-primary,#4176e6);outline-offset:2px}";
