window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		const css$3 = ".LLI1OG_panel{z-index:1000;width:var(--vision-bridge-panel-width,min(440px, 94vw));box-sizing:border-box;border-left:1px solid var(--dsw-alias-border-l2,#0000001f);background:var(--dsw-alias-bg-base,#fff);color:var(--dsw-alias-label-primary,#0f1115);flex-direction:column;font-size:13px;display:flex;position:fixed;inset:0 0 0 auto;overflow:hidden;box-shadow:-12px 0 36px #00000024}@media (width>=760px){#root:has(.LLI1OG_panel){--vision-bridge-panel-width:clamp(360px, 32vw, 440px);width:calc(100% - var(--vision-bridge-panel-width));transition:width var(--ds-transition-duration-slow,.3s) var(--ds-ease-in-out,ease)}}.LLI1OG_header{justify-content:space-between;align-items:flex-start;gap:20px;padding:22px 22px 16px;display:flex}.LLI1OG_title{letter-spacing:-.01em;font-size:18px;font-weight:650;display:block}.LLI1OG_headerHint{color:var(--dsw-alias-label-tertiary,#62666b);margin:5px 0 0;font-size:12px;line-height:1.45}.LLI1OG_close{width:32px;height:32px;color:var(--dsw-alias-label-secondary,#43454a);cursor:pointer;background:0 0;border:0;border-radius:9px;flex:none;place-items:center;padding:0;display:grid}.LLI1OG_close:hover{background:var(--dsw-alias-interactive-bg-hover,#0000000f);color:var(--dsw-alias-label-primary,#0f1115)}.LLI1OG_close:focus-visible,.LLI1OG_tab:focus-visible,.LLI1OG_tabActive:focus-visible,.LLI1OG_actions button:focus-visible,.LLI1OG_textAction:focus-visible,.LLI1OG_previewPlaceholder:focus-visible,.LLI1OG_historyToggle:focus-visible,.LLI1OG_historyToggleExpanded:focus-visible{outline:2px solid var(--dsw-alias-state-business-primary,#4176e6);outline-offset:2px}.LLI1OG_close svg{fill:none;stroke:currentColor;stroke-linecap:round;stroke-width:1.7px;width:18px;height:18px}.LLI1OG_tabs{background:var(--dsw-specific-selector,#f5f6f7);border-radius:11px;grid-template-columns:1fr 1fr;gap:4px;margin:0 22px;padding:4px;display:grid}.LLI1OG_tab,.LLI1OG_tabActive{min-height:36px;color:var(--dsw-alias-label-tertiary,#62666b);cursor:pointer;font:inherit;background:0 0;border:0;border-radius:8px;padding:7px 14px;font-weight:550;transition:background-color .12s,box-shadow .12s,color .12s;position:relative}.LLI1OG_tab:hover{color:var(--dsw-alias-label-primary,#0f1115)}.LLI1OG_tabActive{background:var(--dsw-alias-bg-layer-1,#fff);color:var(--dsw-alias-label-primary,#0f1115);box-shadow:0 1px 4px #00000014}.LLI1OG_tabDot{background:var(--dsw-alias-state-business-primary,#4176e6);border-radius:50%;width:5px;height:5px;margin-left:5px;position:absolute;top:9px}.LLI1OG_content{overscroll-behavior:contain;scrollbar-gutter:stable;flex:1;min-height:0;padding:20px 22px 28px;overflow-y:auto}.LLI1OG_recentList{flex-direction:column;gap:18px;display:flex}.LLI1OG_view{flex-direction:column;gap:16px;display:flex}.LLI1OG_intro{flex-direction:column;align-items:flex-start;gap:9px;display:flex}.LLI1OG_hint{color:var(--dsw-alias-label-secondary,#4f5359);margin:0;line-height:1.6}.LLI1OG_statusReady,.LLI1OG_statusPending,.LLI1OG_latestBadge{border-radius:999px;align-items:center;min-height:22px;padding:2px 8px;font-size:11px;font-weight:600;display:inline-flex}.LLI1OG_statusReady{background:var(--dsw-alias-state-success-tertiary,#e6faed);color:var(--dsw-alias-state-success-primary,#22a955)}.LLI1OG_statusPending{background:var(--dsw-alias-state-warn-tertiary,#fef5e7);color:var(--dsw-alias-state-warn-label,#b26720)}.LLI1OG_card{border:1px solid var(--dsw-alias-border-l2,#0000001a);background:var(--dsw-alias-bg-layer-2,#fff);border-radius:14px;flex-direction:column;gap:13px;padding:16px;display:flex}.LLI1OG_sectionHeading,.LLI1OG_recentHeading,.LLI1OG_entryTopline,.LLI1OG_entryFooter{justify-content:space-between;align-items:center;gap:12px;display:flex}.LLI1OG_historyToggle,.LLI1OG_historyToggleExpanded{box-sizing:border-box;border:1px solid var(--dsw-alias-border-l2,#0000001a);background:var(--dsw-alias-bg-module-platform,#f5f6f7);width:100%;min-height:36px;color:var(--dsw-alias-label-secondary,#4f5359);cursor:pointer;font:inherit;border-radius:9px;justify-content:space-between;align-items:center;padding:7px 10px;font-size:12px;font-weight:550;display:flex}.LLI1OG_historyToggle:hover,.LLI1OG_historyToggleExpanded{background:var(--dsw-alias-interactive-bg-hover,#7f7f7f1a);color:var(--dsw-alias-label-primary,#0f1115)}.LLI1OG_historyToggle svg,.LLI1OG_historyToggleExpanded svg{fill:none;stroke:currentColor;stroke-linecap:round;stroke-linejoin:round;stroke-width:1.5px;width:15px;height:15px;transition:transform .12s}.LLI1OG_historyToggleExpanded svg{transform:rotate(180deg)}.LLI1OG_historyList{flex-direction:column;gap:10px;padding-top:2px;display:flex}.LLI1OG_historyItem{border-left:2px solid var(--dsw-alias-border-l3,#00000029);background:var(--dsw-alias-bg-module-platform,#f5f6f7);border-radius:0 8px 8px 0;padding:11px 12px}.LLI1OG_historyItemHeader{justify-content:space-between;align-items:center;gap:10px;margin-bottom:6px;display:flex}.LLI1OG_historyItemHeader time{color:var(--dsw-alias-label-caption,#969ba1);font-size:10px}.LLI1OG_historyItem>p,.LLI1OG_historyEmpty{color:var(--dsw-alias-label-secondary,#4f5359);overflow-wrap:anywhere;white-space:pre-wrap;margin:0;font-size:12px;line-height:1.6}.LLI1OG_historyEmpty{color:var(--dsw-alias-label-tertiary,#70747a);padding:10px 2px 2px}.LLI1OG_sectionHeading>span,.LLI1OG_recentHeading p,.LLI1OG_entryTopline time{color:var(--dsw-alias-label-tertiary,#777b81);font-size:11px}.LLI1OG_recentHeading{align-items:flex-start}.LLI1OG_recentHeading p{margin:5px 0 0;line-height:1.45}.LLI1OG_subtitle{margin:0;font-size:14px;font-weight:650}.LLI1OG_field{color:var(--dsw-alias-label-secondary,#4f5359);flex-direction:column;gap:7px;font-size:12px;font-weight:550;display:flex}.LLI1OG_field input{box-sizing:border-box;border:1px solid var(--dsw-alias-border-l3,#00000029);background:var(--dsw-specific-input-major,#fff);width:100%;min-height:40px;color:var(--dsw-alias-label-primary,#0f1115);font:inherit;border-radius:9px;outline:none;padding:9px 11px;transition:border-color .12s,box-shadow .12s}.LLI1OG_field input::placeholder{color:var(--dsw-alias-label-caption,#9aa0a6)}.LLI1OG_field input:focus{border-color:var(--dsw-alias-state-business-primary,#4176e6);box-shadow:0 0 0 3px color-mix(in srgb, var(--dsw-alias-state-business-primary,#4176e6) 16%, transparent)}.LLI1OG_actions{gap:8px;padding-top:2px;display:flex}.LLI1OG_actions button{cursor:pointer;min-height:38px;font:inherit;border-radius:9px;flex:1;padding:8px 12px;font-weight:600}.LLI1OG_primaryAction{border:1px solid var(--dsw-alias-button-info-fill,#4176e6);background:var(--dsw-alias-button-info-fill,#4176e6);color:var(--dsw-static-neutral-00,#fff)}.LLI1OG_primaryAction:hover{border-color:var(--dsw-alias-button-info-hover,#5686fe);background:var(--dsw-alias-button-info-hover,#5686fe)}.LLI1OG_secondaryAction{border:1px solid var(--dsw-alias-border-l3,#00000029);background:var(--dsw-alias-bg-layer-3,#fff);color:var(--dsw-alias-label-primary,#0f1115)}.LLI1OG_secondaryAction:hover{background:var(--dsw-alias-interactive-bg-hover-solid,#f1f3f5)}.LLI1OG_actions button:disabled{cursor:not-allowed;opacity:.45}.LLI1OG_textAction{color:var(--dsw-alias-label-secondary,#4f5359);cursor:pointer;font:inherit;background:0 0;border:0;border-radius:7px;flex:none;padding:5px 7px;font-size:12px}.LLI1OG_textAction:hover{background:var(--dsw-alias-interactive-bg-hover,#0000000f);color:var(--dsw-alias-label-primary,#0f1115)}.LLI1OG_note,.LLI1OG_ok,.LLI1OG_error,.LLI1OG_balanceLine{margin:0;font-size:12px;line-height:1.5}.LLI1OG_note{color:var(--dsw-alias-label-tertiary,#70747a)}.LLI1OG_ok{color:var(--dsw-alias-state-success-primary,#22a955)}.LLI1OG_error{color:var(--dsw-alias-state-error-primary,#ec1313)}.LLI1OG_balanceLine{color:var(--dsw-alias-label-secondary,#4f5359)}.LLI1OG_empty{box-sizing:border-box;border:1px dashed var(--dsw-alias-border-l3,#00000029);background:var(--dsw-alias-bg-module-platform,#f7f8f9);text-align:center;border-radius:16px;flex-direction:column;justify-content:center;align-items:center;min-height:300px;padding:44px 32px;display:flex}.LLI1OG_emptyIcon{background:var(--dsw-alias-state-business-tertiary,#e4edfd);width:52px;height:52px;color:var(--dsw-alias-state-business-primary,#4176e6);border-radius:15px;place-items:center;margin-bottom:17px;display:grid}.LLI1OG_emptyIcon svg{fill:none;stroke:currentColor;stroke-linecap:round;stroke-linejoin:round;stroke-width:1.5px;width:27px;height:27px}.LLI1OG_empty h3{margin:0 0 8px;font-size:14px}.LLI1OG_empty p{max-width:280px;color:var(--dsw-alias-label-tertiary,#70747a);margin:0;font-size:12px;line-height:1.65}.LLI1OG_entry{border:1px solid var(--dsw-alias-border-l2,#0000001a);background:var(--dsw-alias-bg-layer-2,#fff);border-radius:16px;overflow:hidden}.LLI1OG_preview{background:var(--dsw-alias-bg-module-platform,#f5f6f7);place-items:center;min-height:210px;max-height:280px;display:grid;overflow:hidden}.LLI1OG_thumb{object-fit:contain;width:100%;height:240px;display:block}.LLI1OG_previewPlaceholder{width:100%;min-height:210px;color:var(--dsw-alias-label-tertiary,#70747a);cursor:pointer;font:inherit;background:0 0;border:0;font-size:12px}.LLI1OG_entryBody{border-top:1px solid var(--dsw-alias-border-l1,#0000000f);flex-direction:column;gap:12px;padding:16px;display:flex}.LLI1OG_latestBadge{background:var(--dsw-alias-state-business-tertiary,#e4edfd);color:var(--dsw-alias-state-business-primary,#4176e6)}.LLI1OG_description{color:var(--dsw-alias-label-primary,#0f1115);overflow-wrap:anywhere;white-space:pre-wrap;margin:0;font-size:13px;line-height:1.7}.LLI1OG_entryFooter{min-width:0;padding-top:2px}.LLI1OG_meta{min-width:0;color:var(--dsw-alias-label-caption,#969ba1);font-family:var(--ds-font-family-code,monospace);text-overflow:ellipsis;white-space:nowrap;margin:0;font-size:10px;overflow:hidden}@media (width<=520px){.LLI1OG_header{padding:18px 16px 14px}.LLI1OG_tabs{margin:0 16px}.LLI1OG_content{padding:16px}}@media (prefers-reduced-motion:reduce){.LLI1OG_tab,.LLI1OG_tabActive,.LLI1OG_field input{transition:none}}";
		...
		var VisionBridgePanel_module_css_default = {
			"actions": "LLI1OG_actions",
			"balanceLine": "LLI1OG_balanceLine",
			"card": "LLI1OG_card",
			"close": "LLI1OG_close",
			...
			"primaryAction": "LLI1OG_primaryAction",
			"recentHeading": "LLI1OG_recentHeading",
			"recentList": "LLI1OG_recentList",
			"secondaryAction": "LLI1OG_secondaryAction",
			"sectionHeading": "LLI1OG_sectionHeading",
			"statusPending": "LLI1OG_statusPending",
			"statusReady": "LLI1OG_statusReady",
			"subtitle": "LLI1OG_subtitle",
			"tab": "LLI1OG_tab",
			"tabActive": "LLI1OG_tabActive",
			"tabDot": "LLI1OG_tabDot",
			"tabs": "LLI1OG_tabs",
		...
		*/
		...
		//#endregion
		//#region \0dsh-css:src/client/VisionBridgeToggle.module.css.mjs
		const css$2 = ".Hvp_5q_toggle{color:var(--dsw-alias-label-secondary,inherit);cursor:pointer;background:0 0;border:none;border-radius:6px;align-items:center;gap:6px;padding:6px 10px;font-size:13px;display:inline-flex}.Hvp_5q_toggle:hover,.Hvp_5q_toggle[aria-pressed=true]{background:var(--dsw-alias-interactive-bg-hover,#7f7f7f1a);color:var(--dsw-alias-label-primary,inherit)}.Hvp_5q_toggle:focus-visible{outline:2px solid var(--dsw-alias-state-business-primary,#4176e6);outline-offset:2px}";
		...
		var VisionBridgeToggle_module_css_default = { "toggle": "Hvp_5q_toggle" };
		//#endregion
		...
		*/
		...
		const css = "._02Vn4q_list{flex-direction:column;gap:8px;width:100%;display:flex}";
